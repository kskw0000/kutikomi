        ...
        <div class="mypage_inner">
            <div class="common_inner">
                ...
                <h1 class="mypage_title">
                    ...
                    {{session('user')['name']}}さんの下書き中の口コミ
                    @endif  
                </h1>
                <p class="mypage_text">
                    「編集する」ボタンを押すと、下書き中の口コミを編集できます。
                </p>
                ...
                <div class="mypage_menu_block">
                    ...
                    <div class="mypage_menu_box">
                        ...
                        <ul class="mypage_menu_list">
                            ...
                            <li class="mypage_menu_item">
                                <a href="http://napps-log.com/" class="mypage_menu_link" target="_blank" rel="noopener noreferrer">個人情報の取り扱いについて</a>
                            </li>
                            <li class="mypage_menu_item">
