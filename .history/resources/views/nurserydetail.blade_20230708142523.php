                ...
                <div class="school-d_mv_block">
                    <div class="school-d_mv_main">
                        ...
                        <div class="company-banner-sp">
                            <a href="https://lin.ee/FfhxqgP" target="_blank" rel="noopener noreferrer" class="top_mv_bnr_block">
                                <img src="{{asset('assets/user/images/top/banner_sp_march2.png')}}" alt="オープン記念キャンペーン" class="common_sp_640">
                            </a>
                        </div>
                        ...
                        <div class="common_sp">
                            <div class="school-d_mv_graph school_content_relative">
                                <img src="{{asset('assets/user/images/school/detail/character01.svg')}}" alt="保育士Reach" class="school-d_mv_character">
        ...
        <ul class="qa_list">
            ...
            <li class="qa_item">
                ...
                <div class="qa_answer_block">
                    <p class="qa_answer_text">
                        <span class="qa_answer_icon">A.</span>
                        <span>姉妹サービスである<a href="https://lin.ee/FfhxqgP" target="_blank" rel="noopener noreferrer" style="display: inline">保育士Reach</a>にて口コミの評価が高いご希望に沿った保育園をご紹介することが可能です。</span>
                    </p>
                </div>
            </li>
            <li class="qa_item">
  ...
  <div class="common_sp sp">
      ...
      <div class="school-sp_popup_inner btn_fixed">
          <p class="popup_report_text">
              ...
              ご報告いただいた内容については保育士Reach事務局で確認の上適宜対応を行っておりますので、反映にお時間いただく場合がございます。<br>
...
<div class="popup_wrap" id="EventPopWindow" style="background-color: transparent; padding: 10px 10px; max-width: 550px;">
  ...
  <div class="align_center">
    <a href="https://lin.ee/FfhxqgP" target="_blank" rel="noopener noreferrer">
