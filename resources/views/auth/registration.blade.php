                ...
                <div class="register_bg_wrap register_form">
                    ...
                    <ul class="form_list register">
                        <li class="form_item">
                            ...
                            @if ($errors->has('name'))
                                <p class="form_error_text">このニックネームは既に存在しています。</p>                            
                            @endif
                        ...
                        <li class="form_item">
                            ...
                            @if ($errors->has('zip_code'))     
                                <p class="form_error_text">郵便番号は7文字で指定してください。</p>
                            @endif
                        </li>
                        <li class="form_item">
                        ...
                        <li class="form_item">
                            ...
                            >
                            @if ($errors->has('email'))
                                <p class="form_error_text">このメールアドレスは既に存在しています。</p>                            
                            @endif
                        </li>
                        <li class="form_item">
                            ...
                            <div class="form_pwd_block">
                                ...
                                @if ($errors->has('password'))
                                    <p style="font-family: dnp-shuei-mgothic-std; margin-top: 5px; color: red;">※8字以上で設定してください</p>
                                @else
