...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route('admin.nursery.store')}}">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <select class="form-select form-control form-control-user @error('facility') is-invalid @enderror" name="facility[]" multiple>
                            <option selected disabled></option>
                            @foreach ($facilities as $facilityItem)
                                <option value="{{$facilityItem->id}}">{{$facilityItem->name}}</option>
                            @endforeach
                        </select>
                        @error('prefecture_id')
                            <span class="text-danger">{{$message}}</span>
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <select class="form-control form-control-user @error('cooperate_id') is-invalid @enderror" name="cooperate_id">
                            <option selected disabled></option>
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('admin.nursery.index') }}">キャンセル</a>
            </div>
        </form>
    </div>
