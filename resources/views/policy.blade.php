      ...
      <div class="common_inner_s">
          ...
          <div class="others_bg_wrap">
              ...
              <p class="others_policy_text align_center">
                  保育ひろばは保育士へより質の高い、<br class="common_pc_640">信頼性のある情報をお届けするために、<br class="common_pc_640">以下の取り組みを行っています。
              </p>
                      ...
                      <li class="others_point_item">
                          <div class="others_point_main">
                              <h3 class="others_point_title">
                                  <span>1</span>保育ひろば運営事務局に<br class="common_sp_640">よる目視確認
                              </h3>
                              <p class="others_point_text">
                                  保育ひろばでは、保育業界に対しネガティブな影響を与えないよう努力する責任があると考えています。投稿された口コミは、システムでのチェックはもちろん、事務局にて目視確認も行っております。<br>
              ...
              <p class="others_policy_sub_text">
                  保育ひろばでのスコアは、保育士からの回答をもとに有効なスコアのみを集計し、表示しています。<br>
                  スコアは単純平均ではなく、より信頼性を高めるために保育ひろば独自のアルゴリズムにより算出しています。アルゴリズムは日々アップデートを行っているため、新規投稿がなくてもスコアが変動する場合がございます。<br>
